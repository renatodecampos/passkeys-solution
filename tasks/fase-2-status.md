...
> Estas instruções são lidas automaticamente quando você executa `/feature-dev execute a fase 2`

**Pré-condição**: verifique que `tasks/fase-1b-testes-server.md` está `[x] completed`. Se não estiver, pare e informe.
