...
> Estas instruções são lidas automaticamente quando você executa `/feature-dev execute a fase 1b`

**Pré-condição**: verifique que `tasks/fase-1-status.md` está `[x] completed`. Se não estiver, pare e informe.
