...
> Estas instruções são lidas automaticamente quando você executa `/feature-dev execute a fase 3`

**Pré-condição**: verifique que `tasks/fase-2-status.md` está `[x] completed`. Se não estiver, pare e informe.
